...
export const JSCallback = () => {
  ...
  // Basic Example
  const basicFunction = (callbackFun: { (message: string): void }) => {
    console.log(
  ...
  // Array Example
  const processArray = (arr: number[], callback: { (x: number): number }) => {
    ...
    <>
      ...
      <section className="grid gap-6">
        ...
        <div className="bg-gray-800 p-4 rounded-lg">
          ...
          <Button
            handleClick={() =>
              simulateAsyncOperation((result: any) => console.log(result))
            }
